...
public class RedisChatClient
{
    public static void RedisChatClientMain()
    {
        ...
        Thread thread = new Thread(o => ReceiveRedisData((TcpClient)o));
        thread.Start(client);
    ...
    private static void ReceiveRedisData(TcpClient client)
    {
        NetworkStream stream = client.GetStream();
